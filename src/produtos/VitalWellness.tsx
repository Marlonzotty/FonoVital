...
export default function VitalWellness() {
  ...
  useEffect(() => {
    ...
    const vitalWellnessPixelId = '1585803135719870';
  ...
  return (
    <main className="vital-wellness-page overflow-hidden bg-[#f7fbfb] text-slate-900">
      ...
      <section className="bg-[#0c3137] px-5 py-20 text-center text-white sm:px-8 lg:py-28"><div className="mx-auto max-w-3xl"><p className="text-sm font-bold uppercase tracking-[.2em] text-[#8de4d9]">Comece hoje</p><h2 className="mt-4 text-4xl font-semibold tracking-[-.04em] sm:text-5xl">Uma pulseira. Uma rotina inteira de informações.</h2><p className="mx-auto mt-5 max-w-xl text-lg leading-8 text-slate-300">Mais tranquilidade para quem cuida. Mais liberdade para quem usa.</p><a href={checkoutUrl} data-google-ads-purchase="true" className="btn-3d mt-8 inline-flex items-center gap-2">Comprar por R$ 350,00 <Waves size={18} /></a><div className="mx-auto mt-8 max-w-sm rounded-2xl bg-white px-4 py-2"><MercadoPagoSeal /></div><p className="mt-3 text-sm text-slate-300">Pagamento seguro processado pelo Mercado Pago.</p><p className="mt-6 text-xs leading-5 text-slate-400">FonoVital • CNPJ 61.894.698/0001-20<br />A Vital Wellness é voltada ao acompanhamento de bem-estar e atividade. As informações não substituem avaliação, diagnóstico ou acompanhamento de profissionais de saúde.</p><noscript><img height="1" width="1" style={{ display: 'none' }} src="https://www.facebook.com/tr?id=1585803135719870&ev=PageView&noscript=1" alt="" /></noscript></div></section>
      <Footer />
    </main>
  );
}

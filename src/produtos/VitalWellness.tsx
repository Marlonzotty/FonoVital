...
export default function VitalWellness() {
  ...
  return (
    <main className="vital-wellness-page overflow-hidden bg-[#f7fbfb] text-slate-900">
        ...
        <div className="relative mx-auto grid max-w-7xl items-center gap-10 lg:grid-cols-[.92fr_1.08fr] lg:gap-16">
          <div>
            ...
            <div className="mt-8 flex flex-col gap-4 sm:flex-row sm:items-center">
              <a href={checkoutUrl} data-google-ads-purchase="true" className="btn-3d vital-cta inline-flex items-center justify-center gap-2"><HeartPulse size={19} /> Quero minha Vital Wellness</a>
      ...
      <div className="fixed inset-x-4 bottom-4 z-40 flex justify-center sm:inset-x-auto sm:right-6 sm:justify-end"><a href={checkoutUrl} data-google-ads-purchase="true" className="btn-3d vital-cta inline-flex w-full items-center justify-center gap-2 rounded-full px-6 py-3 shadow-2xl sm:w-auto"><HeartPulse size={18} /> Comprar Vital Wellness</a></div>
      <Footer />
    </main>
  );
}

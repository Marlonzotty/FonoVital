  ...
  return (
    <section className="pt-32 pb-20 px-4 bg-white">
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mt-16">
          <h2 className="text-2xl font-bold text-[#213547] mb-4">Por que escolher o Voxcharge?</h2>
          ...
          <div className="mt-12">
            ...
            <div className="space-y-4">
              <details className="border rounded-md p-4 cursor-pointer">
                <summary className="font-semibold text-[#4A90E2]">Precisa de exames para usar o Voxcharge?</summary>
                <p className="mt-2 text-gray-600">Não. Ele é pronto para uso, mas o teste auditivo gratuito pode ajudar a orientar sua escolha.</p>
              </details>
              <details className="border rounded-md p-4 cursor-pointer">
                <summary className="font-semibold text-[#4A90E2]">Qual a diferença entre Voxcharge e Voxton?</summary>
                <p className="mt-2 text-gray-600">O Voxcharge oferece maior autonomia e potência, sendo ideal para quem deseja mais durabilidade sem perder conforto.</p>
              </details>
              <details className="border rounded-md p-4 cursor-pointer">
                <summary className="font-semibold text-[#4A90E2]">Serve para idosos?</summary>
                <p className="mt-2 text-gray-600">Sim, o design e funcionamento são simples, ideais para uso em todas as idades.</p>
              </details>
            </div>
          </div>
          ...
          <div className="mt-16 text-center">
            <p className="text-2xl font-bold text-[#213547] mb-4">Ouça melhor com o Voxcharge!</p>
            <a
              href={dados.link}
              target="_blank"
              rel="noopener noreferrer"
